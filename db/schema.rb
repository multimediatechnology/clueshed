...
ActiveRecord::Schema.define(version: 20160206073435) do
  ...
  add_index "events", ["contrib_id"], name: "index_events_on_contrib_id", using: :btree
  ...
  add_foreign_key "events", "contribs"
end
